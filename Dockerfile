...
RUN apt-get update && apt-get install -y  default-jre-headless git-core libcurl4-openssl-dev libgit2-dev libicu-dev libssl-dev libxml2-dev make pandoc pandoc-citeproc zlib1g-dev && rm -rf /var/lib/apt/lists/*
...
RUN Rscript -e 'remotes::install_version("DatabaseConnector",upgrade="never", version = "5.0.3")'
RUN Rscript -e 'remotes::install_github("ohdsi/SqlRender@cd4b16ab46a3c64e4ef5bc2119a55056f2585faf")'
RUN Rscript -e 'remotes::install_github("ohdsi/ROhdsiWebApi@f48f8f593b4e9e073e56669dcb5541b098548df8")'
...
EXPOSE 3838
CMD  ["R", "-e", "options('shiny.port'=3838,shiny.host='0.0.0.0');CohortsExport::run_app()"]
