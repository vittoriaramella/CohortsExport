...
golem::add_module(name = "select_concepts", with_test = TRUE) # Name of the module
golem::add_module(name = "dynamic_table_tabs", with_test = TRUE) # Name of the module
...
## Vignette ----
usethis::use_vignette("CohortsExport")
